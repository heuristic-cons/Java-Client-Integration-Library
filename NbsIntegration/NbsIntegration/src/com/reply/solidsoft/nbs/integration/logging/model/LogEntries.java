 ...
 * A collection of log entries.
 */
public class LogEntries implements List<LogEntry> {

    /**
     * The inner list of log entries.
     */
    private final List<LogEntry> logEntriesList = new ArrayList<>();

    /**
     * Initializes a new instance of the LogEntries class.
     */
    public LogEntries() {
    }
    ...
    public LogEntries(List<LogEntry> logEntries) {
        ...
        logEntries.forEach((LogEntry logEntry) -> {
            boolean add;
            add = LogEntries.this.add(logEntry);
        });
    }
    ...
    public final int size() {
        return this.logEntriesList.size();
    }
     ...
     */
    @Override
    public final LogEntry get(int index) {
        return this.logEntriesList.get(index);
    }
     ...
     * @param logEntry element to be stored at the specified position
     ...
     */
    @Override
    public final LogEntry set(int index, LogEntry logEntry) {
        return this.logEntriesList.set(index, logEntry);
    }
    ...
    public final boolean contains(Object objectValue) {
        LogEntry logEntry = (LogEntry) objectValue;
        return this.logEntriesList.contains(logEntry);
    }
    ...
    public List<LogEntry> subList(int fromIndex, int toIndex) {
        return this.logEntriesList.subList(fromIndex, toIndex);
    }
    ...
    public final Iterator<LogEntry> iterator() {
        return this.logEntriesList.iterator();
    }
    ...
    public final int indexOf(Object objectValue) {
        LogEntry logEntry = (LogEntry) objectValue;
        return this.logEntriesList.indexOf(logEntry);
    }
     ...
     * @param logEntry element to be inserted
     ...
     */
    @Override
    public final void add(int index, LogEntry logEntry) {
        this.logEntriesList.add(index, logEntry);
    }
    ...
    public final boolean remove(Object o) {
        ...
        return this.logEntriesList.remove(logEntry);
    }
     ...
     */
    @Override
    public final LogEntry remove(int index) {
        return this.logEntriesList.remove(index);
    }
    ...
    public ListIterator<LogEntry> listIterator(int index) {
        return this.logEntriesList.listIterator(index);
    }
    ...
    public ListIterator<LogEntry> listIterator() {
        return this.logEntriesList.listIterator();
    }
    ...
    public int lastIndexOf(Object o) {
        return this.logEntriesList.lastIndexOf(o);
    }
    ...
    public boolean retainAll(Collection<?> c) {
        return this.logEntriesList.retainAll(c);
    }
    ...
    public boolean removeAll(Collection<?> c) {
        return this.logEntriesList.removeAll(c);
    }
    ...
    public boolean addAll(Collection<? extends LogEntry> c) {
        return this.logEntriesList.addAll(c);
    }
     ...
     */
    @Override
    public boolean addAll(int index, Collection<? extends LogEntry> c) {
        return this.logEntriesList.addAll(index, c);
    }
    ...
    public boolean containsAll(Collection<?> c) {
        return this.logEntriesList.containsAll(c);
    }
     ...
     */
    @Override
    public final boolean add(LogEntry e) {
        return this.logEntriesList.add(e);
    }
     ...
     * <tt>toArray()</tt>.
     *
     * @param <LogEntry> The type of entry.
     * @param logEntryArray the array into which the elements of this list are
    ...
    public <LogEntry> LogEntry[] toArray(LogEntry[] logEntryArray) {
        return this.logEntriesList.toArray(logEntryArray);
    }
    ...
    public Object[] toArray() {
        return this.logEntriesList.toArray();
    }
    ...
    public boolean isEmpty() {
        return this.logEntriesList.isEmpty();
    }
}

...
public class HttpStatusCode {
    ...
    // --------------------------------------------------------- Public Methods
    /**
     * Get the reason phrase for a particular status code. This method always
     * returns the English text as specified in the relevent RFCs and is not
     * internationalized.
     *
     ...
     */
    public static final int SC_NOTDEFINED = 0;

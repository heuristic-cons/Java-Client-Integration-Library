/**
 * -----------------------------------------------------------------------------
 * File=ClientCredentialsCollection.java
...
/**
 * A collection of client credentials.
 */
public class ClientCredentialsCollection implements List<ClientCredentials> {

    /**
     * The inner list of log entries.
     */
    private final List<ClientCredentials> clientCredentialsList = new ArrayList<>();

    /**
     * Initializes a new instance of the ClientCredentialsCollection class.
     */
    public ClientCredentialsCollection() {
    }

    /**
     * Initializes a new instance of the ClientCredentialsCollection class.
     *
     * @param logEntries The log entries collection.
     *
     */
    public ClientCredentialsCollection(List<ClientCredentials> logEntries) {
        if (logEntries == null) {
            return;
        }

        logEntries.forEach((ClientCredentials clientCredentials) -> {
            boolean add;
            add = ClientCredentialsCollection.this.add(clientCredentials);
        });
    }
    ...
    public final int size() {
        return this.clientCredentialsList.size();
    }
     ...
     */
    @Override
    public final ClientCredentials get(int index) {
        return this.clientCredentialsList.get(index);
    }
     ...
     * @param clientCredentials element to be stored at the specified position
     ...
     */
    @Override
    public final ClientCredentials set(int index, ClientCredentials clientCredentials) {
        return this.clientCredentialsList.set(index, clientCredentials);
    }
    ...
    public final void clear() {
        this.clientCredentialsList.clear();
    }
     ...
     *
     * @param objectValue element whose presence in this list is to be tested
    ...
    public final boolean contains(Object objectValue) {
        ClientCredentials clientCredentials = (ClientCredentials) objectValue;
        return this.clientCredentialsList.contains(clientCredentials);
    }
     ...
     */
    @Override
    public List<ClientCredentials> subList(int fromIndex, int toIndex) {
        return this.clientCredentialsList.subList(fromIndex, toIndex);
    }
     ...
     */
    @Override
    public final Iterator<ClientCredentials> iterator() {
        return this.clientCredentialsList.iterator();
    }
     ...
     *
     * @param objectValue element to search for
    ...
    public final int indexOf(Object objectValue) {
        ClientCredentials clientCredentials = (ClientCredentials) objectValue;
        return this.clientCredentialsList.indexOf(clientCredentials);
    }
     ...
     * @param clientCredentials element to be inserted
     ...
     */
    @Override
    public final void add(int index, ClientCredentials clientCredentials) {
        this.clientCredentialsList.add(index, clientCredentials);
    }
    ...
    public final boolean remove(Object o) {
        ...
        return this.clientCredentialsList.remove(clientCredentials);
    }
     ...
     */
    @Override
    public final ClientCredentials remove(int index) {
        return this.clientCredentialsList.remove(index);
    }
     ...
     */
    @Override
    public ListIterator<ClientCredentials> listIterator(int index) {
        return this.clientCredentialsList.listIterator(index);
    }
     ...
     */
    @Override
    public ListIterator<ClientCredentials> listIterator() {
        return this.clientCredentialsList.listIterator();
    }
    ...
    public int lastIndexOf(Object o) {
        return this.clientCredentialsList.lastIndexOf(o);
    }
    ...
    public boolean retainAll(Collection<?> c) {
        return this.clientCredentialsList.retainAll(c);
    }
    ...
    public boolean removeAll(Collection<?> c) {
        return this.clientCredentialsList.removeAll(c);
    }
     ...
     */
    @Override
    public boolean addAll(Collection<? extends ClientCredentials> c) {
        return this.clientCredentialsList.addAll(c);
    }
     ...
     */
    @Override
    public boolean addAll(int index, Collection<? extends ClientCredentials> c) {
        return this.clientCredentialsList.addAll(index, c);
    }
    ...
    public boolean containsAll(Collection<?> c) {
        return this.clientCredentialsList.containsAll(c);
    }
     ...
     */
    @Override
    public final boolean add(ClientCredentials e) {
        return this.clientCredentialsList.add(e);
    }
     ...
     * <tt>toArray()</tt>.
     *
     * @param <ClientCredentials> The type of entry.
     * @param clientCredentialsArray the array into which the elements of this
     * list are to be stored, if it is big enough; otherwise, a new array of the
    ...
    public <ClientCredentials> ClientCredentials[] toArray(ClientCredentials[] clientCredentialsArray) {
        return this.clientCredentialsList.toArray(clientCredentialsArray);
    }
    ...
    public Object[] toArray() {
        return this.clientCredentialsList.toArray();
    }
    ...
    public boolean isEmpty() {
        return this.clientCredentialsList.isEmpty();
    }

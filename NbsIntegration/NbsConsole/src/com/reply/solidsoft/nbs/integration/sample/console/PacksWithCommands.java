// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PacksWithCommands.cs" company="Solidsoft Reply Ltd.">
 ...
 */
public class PacksWithCommands implements List<PackCommand> {
    /**
     * The inner list of packs.
     */
    private final List<PackCommand> packList = new ArrayList<>();
     ...
     */
    @Override
    public PackCommand get(int index) {
     ...
     */
    @Override
    public PackCommand set(int index, PackCommand element) {
     ...
     */
    @Override
    public boolean add(PackCommand pack) {
     ...
     */
    public boolean contains(PackCommand pack) {
     ...
     * list.
     */
    public PackCommand[] toArray(PackCommand[] array) {
     ...
     */
    @Override
    public Iterator<PackCommand> iterator() {
     ...
     */
    public int indexOf(PackCommand pack) {
     ...
     */
    @Override
    public void add(int index, PackCommand pack) {
     ...
     */
    public boolean remove(PackCommand pack) {
     ...
     */
    @Override
    public boolean addAll(Collection<? extends PackCommand> c) {
     ...
     */
    @Override
    public boolean addAll(int index, Collection<? extends PackCommand> c) {
        return this.packList.addAll(c);
    }
     ...
     */
    @Override
    public PackCommand remove(int index) {
     ...
     */
    @Override
    public ListIterator<PackCommand> listIterator() {
     ...
     */
    @Override
    public ListIterator<PackCommand> listIterator(int index) {
     ...
     */
    @Override
    public List<PackCommand> subList(int fromIndex, int toIndex) {
